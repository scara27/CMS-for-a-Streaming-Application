...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <h1 class="text-2xl font-bold mb-6 text-center">Add TV Show</h1>
        <form action="{{ route('content.store.tvshow') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex justify-center">
                <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-lg" onclick="alert('TV Show added')">Add TV Show</button>
            </div>
        </form>
